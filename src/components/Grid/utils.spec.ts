...
import { findWordBoundaries, isStartOfWord, isStartOfAnyWord, numberCells } from "./utils";
...
test("isStartOfWord correctly detects word starts", () => {
  expect(isStartOfWord(fiveByFive, { row: 0, col: 1, direction: "row" })).toBeTruthy()
  expect(isStartOfWord(fiveByFive, { row: 0, col: 2, direction: "row" })).toBeFalsy()
  expect(isStartOfWord(fiveByFive, { row: 0, col: 3, direction: "row" })).toBeFalsy()
  expect(isStartOfWord(fiveByFive, { row: 1, col: 0, direction: "row" })).toBeTruthy()
  expect(isStartOfWord(fiveByFive, { row: 2, col: 0, direction: "row" })).toBeTruthy()
  expect(isStartOfWord(fiveByFive, { row: 3, col: 0, direction: "row" })).toBeTruthy()
  expect(isStartOfWord(fiveByFive, { row: 3, col: 2, direction: "row" })).toBeFalsy()

  expect(isStartOfWord(fiveByFive, { row: 0, col: 1, direction: "col" })).toBeTruthy()
  expect(isStartOfWord(fiveByFive, { row: 0, col: 2, direction: "col" })).toBeTruthy()
  expect(isStartOfWord(fiveByFive, { row: 0, col: 3, direction: "col" })).toBeTruthy()
  expect(isStartOfWord(fiveByFive, { row: 1, col: 0, direction: "col" })).toBeTruthy()
  expect(isStartOfWord(fiveByFive, { row: 2, col: 0, direction: "col" })).toBeFalsy()
  expect(isStartOfWord(fiveByFive, { row: 3, col: 0, direction: "col" })).toBeFalsy()
  expect(isStartOfWord(fiveByFive, { row: 3, col: 2, direction: "col" })).toBeTruthy()
})
